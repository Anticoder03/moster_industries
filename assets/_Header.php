    ...
    <div class=" flex justify-around align-center py-16">
        ...
        <div class="right align-center text-center flex flex-col">
           <span class="uppercase text-2xl text-dark font-bold">
            ...
            <span>
                <i class="fa-solid fa-mobile-screen-button text-4xl text-gray-500"></i><span class="ml-2 text-4xl font-bold text-orange-500">9812-2947-17</span>
            </span>
          
<span>
    <span>Mon-Thu: 6am-4pm;</span>

<span>Fri: 6am-3pm;</span>
</span>
        </div>
    </div>
</body>
